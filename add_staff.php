...
<?php
	...
	<?php
        ...
        mysqli_query($conn,"INSERT INTO tblemployees(FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,SickLeave,CasualLeave,PrivilageLeave,MaternityLeave,role,Phonenumber,Status, location, Staff_ID, Position_Staff) VALUES('$fname','$lname','$email','$password','$gender','$dob','$department','$address','$sick_leave','$casual_leave','$privilage_leave','$maternity_leave','$user_role','$phonenumber','$status', 'NO-IMAGE-AVAILABLE.jpg','$staff_id','$position_staff')         
		") or die(mysqli_error()); ?>
...
<body>
							...
							<section>
								...
								<div class="row">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											<label>Gender :</label>
											<select name="gender" class="custom-select form-control" required="true" autocomplete="off" onchange="toggleMaternityLeave(this)" >
								...
								<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<input name="casual_leave" type="number" class="form-control" required="true" autocomplete="off">
										</div>
									</div>
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											<label>Sick Leave days :</label>
											<input name="sick_leave" type="number" class="form-control" required="true" autocomplete="off">
										</div>
									</div>
                                    <div class="col-md-4 col-sm-12">
										<div class="form-group">
											<label>Privilege Leave days :</label>
											<input name="privilage_leave" type="number" class="form-control" required="true" autocomplete="off">
										</div>
									</div>
								...
								<div class="col-md-4 col-sm-12">
                                   <div class="form-group" id="maternity_leave_container" style="display: none;">
                                       <label>Maternity Leave Days :</label>
                                       <input name="maternity_leave" type="number" class="form-control" required="true" autocomplete="off">
                                   </div>
                                </div>
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
	...
	<!-- js -->
	<script>
     function toggleMaternityLeave(selectElement) {
     var maternityLeaveContainer = document.getElementById('maternity_leave_container');
    
    if (selectElement.value === 'female') {
      maternityLeaveContainer.style.display = 'block';
    } else {
      maternityLeaveContainer.style.display = 'none';
    }
   }
  </script>
