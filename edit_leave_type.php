 ...
 if(isset($_POST['edit']))
{
    ...
    $result = mysqli_query($conn,"update tblleavetype set LeaveType='$leavetype', ltd='$description', date_from='$dtefrom', date_to='$dteto' where id = '$get_id' ");
    if ($result) {
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<textarea name="description" style="height: 5em;" class="form-control text_area" type="text"><?php echo $row['ltd']; ?></textarea>
											</div>
										</div>
									</div>
									<div class="row">
									...
									<table class="data-table table stripe hover nowrap">
										...
										<tbody>
											...
											<tr>
	                                            ...
	                                            <td><?php echo htmlentities($result->ltd);?></td>
