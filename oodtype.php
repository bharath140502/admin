 ...
 if(isset($_POST['add']))
{
     ...
     $query = mysqli_query($conn,"select * from tbloodtype where oodtype = '$oodtype'")or die(mysqli_error());
	 $count = mysqli_num_rows($query);
     
     if ($count > 0){ 
     	echo "<script>alert('OODType Already exist');</script>";
      }
      else{
        $query = mysqli_query($conn,"insert into tbloodtype (oodtype, description, date_from, date_to)
  		 values ('$oodtype', '$description', '$dtefrom', '$dteto')      
		") or die(mysqli_error()); 

		if ($query) {
			echo "<script>alert('OOD Type Added');</script>";
			echo "<script type='text/javascript'> document.location = 'oodtype.php'; </script>";
		}
    }
							...
							<div class="col-md-6 col-sm-12">
								...
								<nav aria-label="breadcrumb" role="navigation">
									<ol class="breadcrumb">
										...
										<li class="breadcrumb-item active" aria-current="page"><B>Out of Office Duty</B> Module</li>
									</ol>
								</nav>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-4 col-md-6 col-sm-12 mb-30">
							<div class="card-box pd-30 pt-10 height-100-p">
								<h2 class="mb-30 h4">New OOD Type</h2>
								<section>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input name="oodtype" type="text" class="form-control" required="true" autocomplete="off">
											</div>
										</div>
									</div>
									<div class="row">
											...
											<tr>
												...
												<td>
													<div class="table-actions">
														<a href="edit_oodtype.php?edit=<?php echo htmlentities($result->id);?>" data-color="#265ed7"><i class="icon-copy dw dw-edit2"></i></a>
