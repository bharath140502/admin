<?php
    ...
    class PDF extends TCPDF
    {
        public function Header()
        {
            ...
            $this->Cell(0, 10, 'BHORUKA EXTRUSION PVT LIMITED', 0, 1, 'C');
        ...
        public function Body($data)
        {
            ...
            $this->Cell(0, 10, 'Date:'. $data['FromDate'], 0, 1);
            ...
            $this->Cell(0, 10, 'to go out from: ' . $data['StartTime'] . '                                                                                                                     to: ' . $data['EndTime'], 0, 1);
            $this->Cell(0, 10, 'Reason: ' . $data['WorkCovered'], 0, 1);
            $this->Cell(0, 10, 'Approved on:'. $data['HodRemarks'], 0, 1);
            $this->Cell(0, 10, '.............................................................................................................................................................................................', 0, 1);
            $this->Cell(0, 10, '                                                                             FOR SECURITY USE', 0, 1);
            $this->Cell(0, 10, '.............................................................................................................................................................................................', 0, 1);
            $this->Cell(0, 10, 'TIME OUT:                           SIGNATURE OF SECURITY: ........', 0, 1);
            $this->Cell(0, 10, 'TIME IN:                            ', 0, 1);
        }
    }
